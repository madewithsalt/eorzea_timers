    ...
    <div>
      ...
      <div className="container">
          <div className="col-md-12">
            ...
            <h3 className="bordered-header">Version: {VERSION} <span className="small">(<a target="_blank" href="https://github.com/tnbKristi/eorzea_timers/releases">release notes</a>)</span></h3>
